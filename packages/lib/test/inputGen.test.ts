...
describe("merkle tree", () => {
  // Test ensures that merkle root computed out of circuit is the same
  // as the one generated by circom
  test("should generate the same merkle root as the circuit", async () => {
    ...
    // Merkle root from circom merkle tree proof
...
// Tests generated inputs to the merkle proof ZKP match those from a Python implementation:
// https://github.com/AndrewCLu/baby-jubjub, which itself is based on the Efficient ECDSA formulae:
